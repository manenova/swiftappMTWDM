//
//  InformacionTableViewController.swift
//  09-AppContactos
//
...
class InformacionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PersonaCell", for: indexPath) as! InformacionTableViewCell
        ...
        case 0:
            ...
            cell.movilLable.text = modelo.recent[selectedIndexPath.row]["number"]
            cell.noteLabel.text = modelo.recent[selectedIndexPath.row]["notes"]
        ...
        case 1:
            ...
            cell.movilLable.text = modelo.friends[selectedIndexPath.row]["number"]
            cell.noteLabel.text = modelo.friends[selectedIndexPath.row]["notes"]
        default:
            break;
        }
