...
class PersonaTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        switch section {
            case 0:
                return modelo.recent.count
            case 1:
                return modelo.friends.count
            default:
                return 0
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell =
            tableView.dequeueReusableCell(withIdentifier:
                                            "PersonaCell", for: indexPath) as! PersonaTableViewCell
   ...
   override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
       let cell =  tableView.dequeueReusableCell(withIdentifier:
                                        "CabeceraCell") as! CabeceraTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "accion" {
            let destination = segue.destination as! InformacionTableViewController
